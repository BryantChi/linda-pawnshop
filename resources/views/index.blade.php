            ...
            <div class="container">
                <div class="row g-5" id="services">
                    <div class="d-flex justify-content-center align-items-center mb-3">
                        <img src="{{asset('assets/img/00-hp/title_star.png')}}" class="img-fluid me-2" style="height: 80%;width: auto;"
                            alt="">
                        <div class="d-block">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="services-item-box row justify-content-center align-content-center">
                            <div class="col-7 align-self-center">
                                <img src="{{asset('assets/img/00-hp/ser_icon5.png')}}" class="img-fluid" alt="">
                            </div>
                            <div class="col-auto align-self-center p-0 m-0">
                                <img src="{{asset('assets/img/00-hp/ser_line.png')}}" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="services-item-box row justify-content-center align-content-center">
                            <div class="col-7 align-self-center">
                                <img src="{{asset('assets/img/00-hp/ser_icon6.png')}}" class="img-fluid" alt="">
                            </div>
                            <div class="col-auto align-self-center p-0 m-0">
                                <img src="{{asset('assets/img/00-hp/ser_line.png')}}" class="img-fluid" alt="">
                            </div>
                ...
                <div class="container">
                    <div class="row px-0" id="about">
                        <div class="col-lg-6 p-0 m-0">
                            <img src="{{asset('assets/img/00-hp/about_pic.jpg')}}" class="img-fluid about-img" alt="">
                        </div>
                        <div class="col-lg-6 px-lg-5 px-3 py-lg-5 py-4 m-0 align-self-center">
                            ...
                            <div class="row about-description">
                                <div class="col-lg-5">
                                    <img src="{{asset('assets/img/00-hp/about_tick.png')}}" class="img-fluid" alt="">
                                    信任可靠品牌
                                </div>
                                <div class="col-lg-5">
                                    <img src="{{asset('assets/img/00-hp/about_tick.png')}}" class="img-fluid" alt="">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="{{route('about')}}" class="btn-about-more">關於聯大&emsp;<span>more</span>&emsp;〉</a>
                            </div>
                        </div>
                ...
                <div class="container" id="about2">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-auto my-3 text-center p-0 m-0">
                            <img src="{{asset('assets/img/00-hp/step_arrow.png')}}" class="img-fluid img-arrow" alt="">
                        </div>
                        <div class="col-lg-auto col-5 my-3 p-0 m-0">
                            <div class="step-box text-center d-grid align-items-center m-auto">
                        ...
                        <div class="col-12 text-center pt-5 pb-5">
                            <a href="{{route('process')}}" class="btn-step-more">快速借款流程&emsp;<span>more</span>&emsp;〉</a>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center h-100" id="contact">
                    <div class="col-lg-7">
                        ...
                        <div class="d-flex mt-4">
                            <a href="line://ti/p/0286632299" target="_blank"><img src="{{asset('assets/img/00-hp/pur_line.png')}}"
                                    class="img-fluid" alt=""></a>
                            <a href="{{route('interest')}}"><img src="{{asset('assets/img/00-hp/pur_interest.png')}}" class="img-fluid"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row g-3 mt-lg-3 mt-5 contact-qa-more">
                    <div class="col-lg-6">
                        <div class="row g-0 bg-white rounded-30 boxshadow h-100">
                            <div class="col-lg-6">
                                <img src="{{asset('assets/img/00-hp/faq_pic.jpg')}}" class="img-fluid rounded-30-left h-100 w-100"
                            ...
                            <div class="col-lg-6 px-3 py-4 d-grid position-relative">
                                ...
                                <a href="{{route('faq')}}" class="btn-step-more mt-auto">觀看常見問答&emsp;<span>more</span>&emsp;〉</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row g-0 bg-white rounded-30 boxshadow h-100">
                            <div class="col-lg-6">
                                <img src="{{asset('assets/img/00-hp/con_pic.jpg')}}" class="img-fluid rounded-30-left h-100 w-100"
                                    style="object-fit: cover;" alt="">
                            </div>
                            <div class="col-lg-6 px-3 py-4 d-grid position-relative">
                                <p>
